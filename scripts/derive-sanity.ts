...
console.log('  set score      :', sweep.sets[0]?.score, '     expect [ 21, 0 ]')
console.log('  match winner    :', sweep.matchWinnerSide, '           expect null (1 set of best-of-3)')
